      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-left space-y-4 pt-4">
            <p>
              Otto Coder runs AI coding agents with{' '}
            ...
            <p>
              Learn more at{' '}
              <a
                href="https://www.ottocoder.com/docs/getting-started#safety-notice"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 dark:text-blue-400 underline hover:no-underline"
              >
                https://www.ottocoder.com/docs/getting-started#safety-notice
              </a>
            </p>
          </DialogDescription>
        </DialogHeader>
